...
const buildTheme = require(path.resolve(__dirname, '../build-scripts/index.js'))
const webpack = require('webpack')
const webpackConfig = require(path.resolve(__dirname, '../build-scripts/theme-envy.config.js'))
